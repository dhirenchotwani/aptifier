        ...
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="post" action="#">
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  <input class="custom-control-input" id=" customCheckLogin" type="checkbox" name="signed_in">
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="../examples/register.html" class="text-light"><small>Already have an account?</small></a>
            </div>
          </div>
        </div>
      </div>
